...
4. After all probes join, call `read_evidence`. Treat `finding`, `sensor_failed` and `not_tested` as distinct outcomes. A partial or `incomplete` case cannot advance.
